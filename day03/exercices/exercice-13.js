 ...
 *
 * 🎯 MISSION
 * Écrivez une fonction genererMotDePasse(longueur) qui génère et retourne une chaîne aléatoire contenant X fois
 *  la lettre "A" ou un chiffre aléatoire. (Utilisez Math.random()).
 *
...
//console.log(genererMotDePasse(7)); =====> 6AA003A